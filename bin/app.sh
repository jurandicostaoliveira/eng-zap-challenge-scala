  ...
  deploy)
	...
	zap-producer)
      echo '(0^0) ZAP PRODUCER STARTED ....'
    	java -cp target/scala-2.12/Eng-Zap-Challenge-Scala-assembly-0.1.jar br.com.zap.controller.ZapProducerController
    ;;
  zap-consumer)
      echo '(0^0) ZAP CONSUMER STARTED ....'
    	java -cp target/scala-2.12/Eng-Zap-Challenge-Scala-assembly-0.1.jar br.com.zap.controller.ZapConsumerController
    ;;
  viva-producer)
      echo '(0^0) VIVA PRODUCER STARTED ....'
    	java -cp target/scala-2.12/Eng-Zap-Challenge-Scala-assembly-0.1.jar br.com.zap.controller.VivaProducerController
    ;;
  viva-consumer)
      echo '(0^0) VIVA CONSUMER STARTED ....'
    	java -cp target/scala-2.12/Eng-Zap-Challenge-Scala-assembly-0.1.jar br.com.zap.controller.VivaConsumerController
    ;;
  stop)
