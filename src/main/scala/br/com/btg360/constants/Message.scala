...
object Message {
  ...
  val STATUS_IS_UNAVAILABLE_TO_PROCESS: String = "STATUS %d IS UNAVAILABLE TO PROCESS BECAUSE ANOTHER PROCESS HAS TAKEN OVER"
  val APPLIED_REFERENCE_LIST_SUCCESSFULLY: String = "APPLIED THE REFERENCE LIST SUCCESSFULLY"
  val APPLIED_REFERENCE_LIST_SUCCESSFULLY_TO_APP: String = "APPLIED THE REFERENCE LIST TO APP SUCCESSFULLY"
  val APPLIED_PORT_25_SUCCESSFULLY: String = "APPLIED TO PORT 25 EMAIL SUCCESSFULLY"
