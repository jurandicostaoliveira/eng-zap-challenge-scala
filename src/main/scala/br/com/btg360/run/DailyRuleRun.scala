...
object DailyRuleRun extends App {
 ...
 queue.isSmid = true
 queue.userRuleId = 999999

 println("LINK = " + new UrlService().generateUtm(queue))

 //println(">>>> "+ new SocialMinerRepository().allinCrossExists(queue2.rule.allinId))
